...
func init() {
	...
	applyCmd.PersistentFlags().StringVarP(&pxepackageURLFlag, pxepackageURLKey, "i", "http://minio.pxepackagerd.felix.pojtinger.com/pxepackagerd/1/bin/one.pxepackage", "PXE package to use.")
